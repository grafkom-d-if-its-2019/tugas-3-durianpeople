...
var glUtils = {
     ...
     * @param {Number} points
     */
    draw: function (gl, program, mode, vertices, dimension, byte_per_point, gl_modifier) {
        ...
        gl.vertexAttribPointer(vPosition, dimension, gl.FLOAT, false, byte_per_point * Float32Array.BYTES_PER_ELEMENT, 0);
        gl.enableVertexAttribArray(vPosition);
        gl.vertexAttrib3f(vPosition, 0.0, 0.0, 0.0);
        gl = gl_modifier(gl);
        gl.drawArrays(mode, 0, vertices.length/byte_per_point);
    }
};